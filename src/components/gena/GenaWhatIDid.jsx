...
export default function GenaWhatIDid() {
  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeRight} className="flex-[1_0_0] max-lg:flex-none max-lg:w-full max-lg:max-w-[630px] bg-white border border-[#e7e8ed] p-[16px] shadow-grey-card" style={{ borderRadius: 'clamp(24px, 3.3vw, 48px)' }}>
