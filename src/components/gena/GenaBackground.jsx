...
export default function GenaBackground() {
  return (
    <div className="content-center flex flex-wrap max-lg:flex-col gap-[40px] items-center max-lg:items-start p-[40px] lg:p-[80px] relative shrink-0 w-full z-10">
      ...
      <div className="content-stretch flex flex-[1_0_0] max-lg:flex-none max-lg:w-full max-lg:min-w-0 flex-col gap-[24px] items-start min-h-px min-w-[500px] relative max-lg:order-1">
