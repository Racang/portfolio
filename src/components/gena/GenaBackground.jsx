...
export default function GenaBackground() {
  return (
    <motion.div
      ...
      className="content-center flex flex-wrap max-lg:flex-col gap-[40px] items-center max-lg:items-start p-[40px] lg:p-[80px] relative shrink-0 w-full z-10"
    >
      <motion.div variants={fadeLeft} className="aspect-[609/445.24] max-lg:aspect-[609/445.24] content-stretch flex flex-[1_0_0] max-lg:flex-none max-lg:w-full max-lg:max-w-[630px] max-lg:min-w-0 max-lg:min-h-0 flex-col items-start max-h-[456.94px] max-w-[625px] min-h-[292.44px] min-w-[400px] pr-[40px] max-lg:pr-0 relative max-lg:order-2">
