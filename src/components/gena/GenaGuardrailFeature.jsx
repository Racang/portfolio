    ...
    <div className="mx-auto w-full px-[40px] lg:px-[80px] pt-[40px] flex flex-col gap-[30px] bg-[#F7F3F3] items-center relative z-10">
      ...
      <div className="w-full flex flex-col items-center mt-[80px] gap-[40px] pb-[80px]">
        ...
        <motion.div
          ...
          whileInView="visible"
          viewport={viewportOnce}
          className="flex flex-col lg:flex-row gap-[40px] items-center w-full"
        >
          <motion.div variants={fadeLeft} className="flex items-center gap-[16px] shrink-0 justify-center flex-wrap lg:flex-nowrap">
          ...
          <motion.p variants={fadeRight} className="font-normal text-body text-grey-700">
