        ...
        <div className="content-stretch flex flex-col gap-[16px] items-start w-full relative">
          <div className="bg-white border border-[#e7e8ed] border-solid content-stretch flex flex-col items-start p-[16px] relative rounded-[16px] shadow-grey-card shrink-0 w-full max-[1023px]:max-w-[630px]">
            <div className="aspect-[400/300] relative rounded-[16px] shrink-0 w-full">
              <motion.img initial="hidden" whileInView="visible" viewport={customViewport} variants={slowFadeUp} alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[16px] size-full" src={genaImages.imgRectangle82741} />
            </div>
          </div>
          <motion.div initial="hidden" whileInView="visible" viewport={customViewport} variants={slowFadeUp} className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start mt-2 max-[1023px]:w-full">
          ...
          <div className="bg-white border border-[#e7e8ed] border-solid content-stretch flex flex-col items-start p-[16px] relative rounded-[16px] shadow-[0px_3px_16px_0px_rgba(24,74,234,0.09)] shrink-0 w-full max-[1023px]:max-w-[630px]">
            <div className="aspect-[361/270.75] relative rounded-[16px] shrink-0 w-full">
              <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[16px]">
                ...
                <motion.img initial="hidden" whileInView="visible" viewport={customViewport} variants={slowFadeUp} alt="" className="absolute max-w-none object-contain rounded-[16px] size-full" src={genaImages.imgRectangle82742} />
              </div>
            </div>
          </div>
          <motion.div initial="hidden" whileInView="visible" viewport={customViewport} variants={slowFadeUp} className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start mt-2 max-[1023px]:w-full">
          ...
          <div className="bg-white border border-[#e7e8ed] border-solid content-stretch flex flex-col items-start p-[16px] relative rounded-[16px] shadow-[0px_3px_16px_0px_rgba(24,74,234,0.09)] shrink-0 w-full max-[1023px]:max-w-[630px]">
            <div className="aspect-[400/300] relative rounded-[16px] shrink-0 w-full">
                ...
                <div className="absolute inset-0 overflow-hidden rounded-[16px]">
                  <motion.img initial="hidden" whileInView="visible" viewport={customViewport} variants={slowFadeUp} alt="" className="absolute h-[103.22%] left-0 max-w-none top-[-1.61%] w-full" src={genaImages.imgRectangle82743} />
                </div>
            </div>
          </div>
          <motion.div initial="hidden" whileInView="visible" viewport={customViewport} variants={slowFadeUp} className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start mt-2 max-[1023px]:w-full">
