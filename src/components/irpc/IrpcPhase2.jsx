  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={viewportOnce}
        className="flex flex-wrap gap-[30px] items-center w-full"
      >
        {/* Thumbnail 1 */}
        <motion.div variants={scaleIn} className="flex-[1_0_0] min-w-[260px] aspect-video relative rounded-[16px] overflow-hidden shadow-grey-card">
          <img
        ...
        <motion.div
          variants={fadeUp}
          className="flex-[1_0_0] min-w-[280px] flex flex-col gap-[16px] font-fredoka font-normal text-body text-grey-700"
          style={{ fontVariationSettings: "'wdth' 100" }}
        >
      ...
      <motion.p
        ...
        whileInView="visible"
        viewport={viewportOnce}
        className="font-fredoka font-normal text-body text-grey-700 w-full leading-[1.6]"
        style={{ fontVariationSettings: "'wdth' 100" }}
      >
